...
\newtcolorbox{prologuebox}[1]{
    ...
    before upper = {\setlength{\parskip}{0.73em}\setlength{\parindent}{2em}},
}
...
\newenvironment{mathematica}[1][]{
    \begin{notebook}{\expandafter\ifx\expandafter&\detokenize{#1}&\mathematicatitlename\else#1\fi}%
...
\DeclareDocumentCommand\CS{mg}{\texttt{\symbol{`\\}#1\IfNoValueF{#2}{\{#2\}}}}
